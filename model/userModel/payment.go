...
type Payment struct {
	Diamond  int                `json:"diamond" gorm:"type:int;default:0;"`   // 钻石
	Jifen    int                `json:"jifen" gorm:"type:int;default:0;"`     // 积分
	JiyuCoin int                `json:"jiyu_coin" gorm:"type:int;default:0;"` // jiyu币
	Accounts PaymentAccountList `json:"accounts" gorm:"type:json;"`           // 支付账号
}
